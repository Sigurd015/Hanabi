...
namespace Hanabi
{
	...
	void ScriptEngine::InitMono()
	{
		...
		s_Data->AppDomain = mono_domain_create_appdomain("HanabiScriptRuntime", nullptr);
		mono_domain_set(s_Data->AppDomain, true);

		// Move this maybe
		s_Data->CoreAssembly = LoadCSharpAssembly("resources/scripts/Hanabi_ScriptCore.dll");
		PrintAssemblyTypes(s_Data->CoreAssembly);

		MonoImage* assemblyImage = mono_assembly_get_image(s_Data->CoreAssembly);
		MonoClass* monoClass = mono_class_from_name(assemblyImage, "Hanabi", "Test");
