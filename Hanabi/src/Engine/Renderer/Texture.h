...
namespace Hanabi
{
	...
	class Texture2D : public Texture, public RendererResource
	{
	public:
		...
		static RendererResourceType GetStaticResourceType() { return RendererResourceType::Texture2D; }
		virtual RendererResourceType GetRendererResourceType() const { return GetStaticResourceType(); }
	};

	class TextureCube : public Texture, public RendererResource
	{
	public:
		static Ref<TextureCube> Create(const TextureSpecification& specification, const std::array<Buffer, 6>& buffers);
		...
		static RendererResourceType GetStaticResourceType() { return RendererResourceType::TextureCube; }
		virtual RendererResourceType GetRendererResourceType() const { return GetStaticResourceType(); }
	};
}