...
#define HNB_FUNC_SIG __FUNC__
#elif defined(__STDC_VERSION__) && (__STDC_VERSION__ >= 199901)
#define HNB_FUNC_SIG __func__
#elif defined(__cplusplus) && (__cplusplus >= 201103)
#define HNB_FUNC_SIG __func__
#else
#define HNB_FUNC_SIG "HNB_FUNC_SIG unknown!"
#endif
...
#define HNB_PROFILE_END_SESSION()
#define HNB_PROFILE_SCOPE(name)
#define HNB_PROFILE_FUNCTION()
#endif